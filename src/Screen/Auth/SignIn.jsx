import { View, Text, Image, TouchableOpacity, TextInput, Pressable, StyleSheet, Dimensions } from 'react-native'
    ...
    return (
        <View style={Input.MainView}>
            ...
            <View>
                ...
                <TouchableOpacity style={Input.SignUpButton} onPress={() =>
                    navigation.navigate('HomeNav')}>
                    <Text style={Input.SignUpButtonText}>Log In</Text>
                </TouchableOpacity>
